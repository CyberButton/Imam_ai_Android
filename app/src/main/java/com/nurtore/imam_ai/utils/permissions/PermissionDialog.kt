...
class BatteryExceptionPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            "It seems you permanently declined BATTERY permission. " +
                    "You can go to the app settings to grant it."
        } else {
            "This app needs BATTERY permission so that you can talk " +
                    "to your friends."
        }
    }
}